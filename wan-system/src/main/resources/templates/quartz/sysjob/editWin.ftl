...
<form id="dataForm">
    <div class="form-group">
        ...
        <div class="col-xs-12 col-md-4">
            ...
            <input class="form-control" type="text" readonly  id="jobName" name="jobName" maxlength="200" value="${data.jobName}"
                   required/>
        </div>
        <div class="col-xs-12 col-md-4">
            <label for="jobGroup">任务组名<span class="text-danger">*</span></label>
            <input class="form-control" type="text" readonly  id="jobGroup" name="jobGroup" maxlength="200" value="${data.jobGroup}"
                   required/>
        </div>
        <div class="col-xs-12 col-md-4">
