...
import com.duzhuo.common.config.TencentSmsConfig;
...
public class TencentSmsUtils {
     ...
     * @return
     */
    public static String randomYzm(int length){
        String random = Math.random()+"";
        String yzm = random.substring(2,length+2);
        return yzm;
    }
    ...
    /**
     *
     * @param yzm 验证码 入 0123
     * @param phone 手机号 如 15079185135
     * @throws TencentCloudSDKException
     */
    private void sendSms(String yzm,String phone) throws TencentCloudSDKException {
        /* 必要步骤：
